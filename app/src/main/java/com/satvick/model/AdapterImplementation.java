...
public class AdapterImplementation implements AdapterInterface {
    ...
    public void onClickListner(Context context, int postion, String status, List<MyOrderDetailsModel.Response> myOrderDetailsModelList) {
        ...
        if (status.equalsIgnoreCase("Cancel")) {
            ...
            intent.putExtra("product_id", myOrderDetailsModelList.get(postion).productId);
            intent.putExtra("product_quantity", myOrderDetailsModelList.get(postion).getQuantity());
            intent.putExtra("discount", myOrderDetailsModelList.get(postion).coupanCode);
            intent.putExtra("coupan_code", "");
            intent.putExtra("gift_wrap", "");
