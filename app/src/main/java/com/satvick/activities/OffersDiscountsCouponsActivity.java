...
public class OffersDiscountsCouponsActivity extends AppCompatActivity implements View.OnClickListener {
    private ActivityOffersDiscountsCouponsBinding binding;
    private IHelpCenter center;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding=ActivityOffersDiscountsCouponsBinding.inflate(getLayoutInflater());
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.rlMyCoupons: center.showBottomSheet(this,binding.couponText.getText().toString()); break;
            case R.id.rlIAmUnable: center.showBottomSheet(this,binding.iAmUnableText.getText().toString()); break;
            case R.id.rlInstant: center.showBottomSheet(this,binding.instantText.getText().toString()); break;
            case R.id.rlWallet: center.showBottomSheet(this,binding.wallet.getText().toString()); break;
            case R.id.rlDiscount: center.showBottomSheet(this,binding.discountText.getText().toString()); break;
