...
public class ProductListActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        ...
        if (type.equalsIgnoreCase(GlobalVariables.flashSale)) {
            finish();
            startActivity(new Intent(this, ProductCategoriesActivity.class).putExtra("filterData", SharedPreferenceWriter.getInstance(this).getString(GlobalVariables.section_name)).putExtra("from", getIntent().getStringExtra(GlobalVariables.section_name)));
